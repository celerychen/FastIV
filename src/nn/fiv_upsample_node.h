...
#ifndef _FIV_UPSAMPLE_NODE_H_
#define _FIV_UPSAMPLE_NODE_H_
...
/* x2 nearest-neighbor upsampling node over the last two (h, w) dims; leading
   dims (batch/channels) are upsampled independently. No parameters.
