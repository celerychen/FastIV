...
#include "fiv_lp_solve.h"  /* public fiv_lp_mat (opaque) + its constructors */
 ...
 *
 * INTERNAL header: fiv_lp_mat is opaque to callers (declared in
 * api/fiv_lp_solve.h, which also carries the four public constructors). The
 * definition below completes that type for the module's own sources only.
 * ========================================================================= */
