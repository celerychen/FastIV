...
%CLEXE% /utf-8 /O2 /arch:AVX2 /fp:fast /LTCG "%OBJ%\test_face_api.obj" "%OBJ%\fiv_face.obj" "%OBJ%\fiv_face_warp.obj" "%OBJ%\fiv_face_weights.obj" "%OBJ%\fiv_image_io.obj" "%OBJ%\fiv_image_color_space.obj" "%OBJ%\fiv_nn_infer.obj" "%OBJ%\fiv_nn_topo.obj" "%OBJ%\fiv_nn_train.obj" "%OBJ%\fiv_linear_node.obj" "%OBJ%\fiv_activate_fn.obj" "%OBJ%\fiv_nn_conv2d.obj" "%OBJ%\fiv_flatten_node.obj" "%OBJ%\fiv_max_2d.obj" "%OBJ%\fiv_add_node.obj" "%OBJ%\fiv_pad_node.obj" "%OBJ%\fiv_mat_vec.obj" "%OBJ%\fiv_mat_reduce.obj" "%OBJ%\fiv_mat_mul.obj" "%OBJ%\fiv_ctensor.obj" "%OBJ%\fiv_binary_op.obj" "%OBJ%\fiv_common.obj" /Fe"%BIN%\test_face_api.exe"
if errorlevel 1 (echo [MSVC] link FAILED & exit /b 1)
